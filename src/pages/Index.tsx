  ...
  return (
    <div className="w-full bg-gradient-to-b from-heimdall-white to-heimdall-bg-light text-heimdall-text-body">
      ...
      <main className="container mx-auto px-6">
        {/* Hero Section */}
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden max-w-6xl mx-auto">
          {/* Left Content Area */}
          ...
          <div className="hidden lg:block pointer-events-none absolute right-0 inset-y-0 w-[42vw] max-w-[640px]">
            <div
